        ...
        <div class="footer-widget widget">
            ...
            <div class="footer-inner">
                <ul class="footer-link-address">
                    ...
                    <li class="list"> <span class="address"> <a href="tel:+012-78901234"><i class="{$phone_icon}"></i>{$phone}</a></span></li>
                    <li class="list"> <span class="address"> <a href="mailto:help@mail.com"><i class="{$email_icon}"></i>{$email}</a></span></li>
                </ul>
