...
class LocationController extends Controller
{
    ...
    {
        $request->validate([
            'up_service_city'=> 'required|max:191',
    ...
    {
        $service_areas = ServiceArea::with('city','country')->get();
    ...
    {
        $request->validate([
            'up_service_area'=> 'required|max:191',
