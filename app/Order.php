...
class Order extends Model
{
    ...
    protected $fillable = ['service_id','seller_id','buyer_id','name','email','phone','post_code','address','city','area','country','date','schedule','package_fee','extra_service','sub_total','tax','total','coupon_code','coupon_type','coupon_amount','commission_type','commission_charge','commission_amount','payment_gateway','payment_status','status','order_note'];
