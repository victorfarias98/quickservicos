...
class FeatureService extends \App\PageBuilder\PageBuilderBase
{
    ...
    public function frontend_render() : string
    {
        ...
        $services = Service::select('id','title','image','description','price','slug','seller_id')
                ...
                <div class="single-service {$dot_color_slider}">
                    ...
                    <div class="services-contents">
                        ...
                        <div class="btn-wrapper">
                            <a href="{$book_now}" class="cmn-btn btn-appoinment btn-bg-1" style="background:{$btn_color}"> {$static_text['book_appoinment']} </a>
                        </div>
                    </div>
                </div>
            </div>
