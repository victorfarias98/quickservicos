...
class ServiceListOne extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        $all_services = $service_quyery->where('status', 1)->where('is_service_on', 1)->OrderBy($order_by,$IDorDate)->paginate($items);
...
{
    $image =  render_image_markup_by_attachment_id($service->image,'','','thumb');
    $title =  $service->title;    
    $slug =  $service->slug;  
    ...
    $seller_profile = route('about.seller.profile',$service->seller_id);
        ...
        <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
            ...
            <div class="services-contents">
                ...
                <div class="btn-wrapper d-flex flex-wrap">
                    <a href="{$book_now}" class="cmn-btn btn-small btn-bg-1"> {$static_text['book_now_btn']} </a>
                    <a href="{$route}" class="cmn-btn btn-small btn-outline-1 ml-auto"> {$static_text['read_more_btn']} </a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="single-category-service">
                        <div class="single-select">
                            <select id="search_by_category" name="cat">
                              <option value="">{$static_text['select_category']}</option>
                              $category_markup
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="single-category-service">
                        <div class="single-select">
                            <select id="search_by_subcategory" name="subcat">
                              <option value=""> {$static_text['select_sub_category']}</option>
                               $sub_category_markup
                            </select>
                        </div>
                    </div>
