...
class PopularService extends \App\PageBuilder\PageBuilderBase
{
    ...
    public function frontend_render() : string
    {
        ...
        $services = Service::select('id','title','image','description','price','slug','seller_id','featured')
                        ...
                        <div class="services-contents">
                            ...
                            <div class="service-price-wrapper">
                                ...
                                <div class="btn-wrapper">
                                    <a href="{$book_now}" class="cmn-btn btn-bg-1" style="background:{$btn_color}"> {$static_text['book_now_btn']} </a>
                                </div>
                            </div>
                        </div>
                    </div>
