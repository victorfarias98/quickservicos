...
// frontend starts
Route::group(['middleware' => ['globalVariable', 'maintains_mode']], function () {
    ...
    //  blog routes
    $blog_page_slug = getSlugFromReadingSetting('blog_page');
    ...
    Route::get('/resend-verify-code-again', 'Auth\RegisterController@resendCode')->name('resend.verify.code');
    ...
    Route::group(['prefix' => 'about-seller'], function () {
        //seller profile
        Route::get('/profile/{id}', 'Frontend\ProfileController@profile')->name('about.seller.profile');
    });
