                            ...
                            <form action="<?php if(!empty($commission)): ?><?php echo e(route('admin.commission.update',$commission->id)); ?> <?php else: ?> <?php echo e(route('admin.commission.update')); ?> <?php endif; ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="commission_charge_type"  class="form-control">
                                        <option <?php if(!empty($commission)): ?>value="<?php echo e($commission->commission_charge_type); ?>" selected <?php endif; ?>><?php echo e(ucfirst($commission->commission_charge_type)); ?></option>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\quick\@core\resources\views/backend/pages/admin-commission/admin-commission-all.blade.php ENDPATH**/ ?>