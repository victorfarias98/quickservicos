                                    ...
                                    <table class="custom--table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="<?php echo e(__('Payment Gateway')); ?>"><?php echo e($pay_request->payment_gateway); ?></td>
                                                <td data-label="<?php echo e(__('Request Date')); ?>"><?php echo e($pay_request->created_at->toFormattedDateString()); ?> </td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="payment_gateway" id="payment_gateway" class="form-control nice-select">
                                ...
                                <option value="payfast"><?php echo e(__('Payfast')); ?></option>
                                <option value="payfast"><?php echo e(__('Cashfree')); ?></option>
                                <option value="instamojo"><?php echo e(__('Instamojo')); ?></option>
                                <option value="mercadopago"><?php echo e(__('Mercadopago')); ?></option>
                            </select>
                        </div>
                        <div class="form-group mt-5">
                            <label class="payout-request-note d-block pt-4" for="amount"><?php echo e(__('Note')); ?></label>
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\qixer\@core\resources\views/frontend/user/seller/payout/payout-request.blade.php ENDPATH**/ ?>