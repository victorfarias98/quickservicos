                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($data->discount_type); ?></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select name="up_discount_type" id="up_discount_type" class="form-control nice-select">
                                <option value=""><?php echo e(__('Select Type')); ?></option>
                                <option value="percentage"><?php echo e(__('Percentage')); ?></option>
                                <option value="amount"><?php echo e(__('Amount')); ?></option>
                            </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nazmul/public_html/qixer/@core/resources/views/frontend/user/seller/coupons/coupons.blade.php ENDPATH**/ ?>