...
<?php $__env->startSection('content'); ?>
    ...
    <div class="main-content-inner">
                ...
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            ...
                            <span class="order-para"> <?php echo e(__('Total_buyer')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-md-6">
                <h4 class="mb-3"><?php echo e(__('Most Viewed Services')); ?></h4>
            ...
            <div class="col-md-6">
                <h4 class="mb-3"><?php echo e(__('Most Ordered Services')); ?></h4>
                <div class="table-wrap table-responsive">
                    <table class="table table-bordered">
                        <thead>
                        <th><?php echo e(__('ID')); ?></th>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nazmul/public_html/qixer/@core/resources/views/backend/admin-home.blade.php ENDPATH**/ ?>