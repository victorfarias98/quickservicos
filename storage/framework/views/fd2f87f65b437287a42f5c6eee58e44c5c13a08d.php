    ...
    (function ($) {
        ...
        $(document).ready(function () {
            //Permalink Code
                ...
                var url = `<?php echo e(url('/category/')); ?>/` + sl;
                var data = $('#slug_show').text(url).css('color', 'blue');

                $(document).on('keyup', '#name', function (e) {
                    var slug = $(this).val().trim().toLowerCase().split(' ').join('-');
                    var url = "<?php echo e(url('/category')); ?>/" + slug;
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nazmul/public_html/qixer/@core/resources/views/backend/pages/category/edit_category.blade.php ENDPATH**/ ?>