...
<?php endif; ?>
                                        ...
                                        <table class="custom--table">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $last_10_tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td data-label="Ticket" class="text-left"><?php echo e($ticket->title); ?> </td>
    ...
    <?php $__env->stopSection(); ?>    
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\qixer\@core\resources\views/frontend/user/buyer/dashboard/dashboard.blade.php ENDPATH**/ ?>