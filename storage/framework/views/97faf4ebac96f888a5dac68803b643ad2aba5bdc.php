    ...
    <div class="container">
        <div class="signup-wrapper">
            <div class="signup-contents">
                ...
                <p class="alert alert-success"><?php echo e(Session::get('msg_success')); ?></p>
                <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\qixer\@core\resources\views/frontend/user/email-verify.blade.php ENDPATH**/ ?>