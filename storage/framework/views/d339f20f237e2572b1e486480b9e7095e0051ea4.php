 ...
 <div class="card text-white bg-secondary mb-3 mt-2" style="border:none">
    <div class="card-body home_servie_serach_wrapper">
        ...
        <?php else: ?> 
           <p class="text-left text-warning"><?php echo e("Nothing Found"); ?></p>
        <?php endif; ?>
    </div>
  </div><?php /**PATH D:\xampp\htdocs\qixer\@core\resources\views/frontend/partials/search-result.blade.php ENDPATH**/ ?>