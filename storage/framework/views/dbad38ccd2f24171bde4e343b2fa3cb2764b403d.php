                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title"><?php echo e(__('Deactive Users')); ?></h4>
                                    <small><?php echo e(__('User list who deactive their account from frontend.')); ?></small> <br><br>
...
<?php endif; ?></td>
                                                    ...
                                                    <td>
                                                        <?php if($data->status==0): ?>
                                                          <span class="text-danger"><?php echo e(__('Deactive')); ?></span>
                                                        <?php endif; ?>  
                                                    </td>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\qixer\@core\resources\views/backend/frontend-user/all-deactive-user.blade.php ENDPATH**/ ?>