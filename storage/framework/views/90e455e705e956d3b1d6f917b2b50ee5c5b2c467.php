    ...
    <div class="container">
        <div class="signup-wrapper">
            <div class="signup-contents">
                <h3 class="signup-title"> <?php echo e(__('Sign In')); ?> </h3>
                ...
                <form class="signup-forms" action="<?php echo e(route('user.login')); ?>" method="post">
                    ...
                    <span class="bottom-register"> <?php echo e(__('Don\'t have Account?')); ?> <a class="resgister-link" href="<?php echo e(route('user.register')); ?>"> Register </a> </span>
                </form>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nazmul/public_html/qixer/@core/resources/views/frontend/user/login.blade.php ENDPATH**/ ?>