        ...
        <div class="dashboard-bottom margin-top-35 margin-bottom-50">
            <ul class="dashboard-list ">
                ...
                <li class="list <?php if(request()->is('buyer/all-tickets*')): ?> active <?php endif; ?>">
                    <a href="<?php echo e(route('buyer.support.ticket')); ?>"> <i class="lar la-star"></i><?php echo e(__('Suppot Ticket')); ?></a>
                </li>
...
</div><?php /**PATH D:\xampp\htdocs\qixer\@core\resources\views/frontend/user/buyer/partials/sidebar.blade.php ENDPATH**/ ?>