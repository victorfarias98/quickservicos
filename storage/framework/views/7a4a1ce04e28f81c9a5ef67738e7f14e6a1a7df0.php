                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        <div class="header-wrap d-flex justify-content-between">
                                            ...
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('buyer.support.ticket')); ?>"><?php echo e(__('All Tickets')); ?></a>
                                        </div>
...
<?php endif; ?>
                                            ...
                                            <form action="<?php echo e(route('seller.support.ticket.message.send')); ?>" method="post" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/buyer/support-ticket/view-ticket.blade.php ENDPATH**/ ?>