        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                function getServiceCity(countryId){
                    $.ajax({
                        method: 'post',
                        url: "<?php echo e(route('service.list.book.city')); ?>",
                        data: {
                        ...
                        success: function(res) {
                            if (res.status == 'success') {
                                ...
                                var userSelectedCity = '<?php if(Auth::guard('web')->check()): ?><?php echo e(optional(Auth::guard('web')->user()->city)->id); ?> <?php endif; ?>'
                ...
                function getServiceArea(cityId){
                    $.ajax({
                        method: 'post',
                        url: "<?php echo e(route('service.list.book.area')); ?>",
                        data: {
                            city_id: cityId
                        },
                        success: function(res) {
                            if (res.status == 'success') {
                                ...
                                console.log(allArea);
                                var userSelectedCity = '<?php if(Auth::guard('web')->check()): ?><?php echo e(optional(Auth::guard('web')->user()->area)->id); ?> <?php endif; ?>'
                ...
                $('.extra-services .check-input').click(function(){
                ...
                var aryDates = GetDates(startDate, '<?php echo e($days_count); ?>');
                //show next selected days
                for(var i=0; i<'<?php echo e($days_count); ?>'; i++){
                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            if(res.status=='success'){
                                ...
                                $(".show-schedule").html('<div class="alert alert-warning"><li class="list"><?php echo e(__("Schedule not available")); ?></li></div>');
                            }
                        }
                    })
                })
...
<?php $__env->stopSection(); ?><?php /**PATH D:\xampp\htdocs\qixer\@core\resources\views/frontend/pages/services/service-book-js.blade.php ENDPATH**/ ?>