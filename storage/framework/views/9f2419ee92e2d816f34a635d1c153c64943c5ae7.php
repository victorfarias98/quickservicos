...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Delete Service Attributes')); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                <h2 class="dashboards-title"> <?php echo e(__('Delete Service Attributes')); ?> </h2>
                            </div>
                        </div>
                    </div>
                    <hr>
...
<?php endif; ?>
                        ...
                        <h5 class="mt-3 mb-3"><?php echo e(__('Service Benifits')); ?></h5>
                        <div class="rows dash-single-inner">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th><?php echo e(__('No')); ?></th>
                                        <th><?php echo e(__('Benifits')); ?></th>
                                        <th><?php echo e(__('Action')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nazmul/public_html/qixer/@core/resources/views/frontend/user/seller/services/show-service-attributes-by-id.blade.php ENDPATH**/ ?>