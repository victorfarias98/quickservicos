                ...
                <div class="col-lg-12">
                    <div class="blog-details-wrapper">
                        <div class="single-blog-details">
                            ...
                            <ul class="tags">
                                <li class="list">
                                    <a href="javascript:void(0)"> <i class="las la-clock"></i> {{ optional($blog_post->created_at)->toFormattedDateString() }} </a>
                                </li>
                                <li class="list">
                                            ...
                                            <div class="comment-show-contents padding-top-30">
                                                <div class="about-seller-flex-content style-03">
                                                    ...
                                                    <div class="about-seller-content">
                                                        ...
                                                        <span class="review-date">{{ optional($comment->created_at)->toFormattedDateString() }} </span>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
