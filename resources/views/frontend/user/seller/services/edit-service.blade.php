                                ...
                                <form action="{{route('seller.edit.services',$service->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="single-dashboard-input">
                                        ...
                                        <div class="single-info-input margin-top-30">
                                            ...
                                            <select  name="subcategory" id="subcategory" class="subcategory">
                                                <option @if(!empty( $service->subcategory_id)) value="{{ $service->subcategory_id }}"  @else value="" @endif></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-dashboard-input">
                                        <div class="single-info-input margin-top-30">
                                            ...
                                            <textarea class="form--control textarea--form" name="description" placeholder="{{__('Type Description')}}">{{$service->description}}</textarea>
                                        </div>
                                    </div>
