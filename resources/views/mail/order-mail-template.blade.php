...
<div class="mail-container" style="max-width: 650px;margin: 0 auto;text-align: center;background-color: #f2f2f2;padding: 40px 0;">
    <div class="logo-wrapper">
        ...
        <p>{{ __('Hello') }} <br>
        {{ __('your order has been created succssefully at:') .optional($order_details->created_at)->toFormattedDateString().','. ucwords(str_replace("_", " ", $order_details->payment_gateway)) }}
        ...
        <table class="table table-bordered" style="margin: 0 auto; border: 1px solid #ddd; border-collapse: collapse; width: 100%; margin-bottom: 30px;">
            ...
            <tbody>
                ...
                <tr class="table-row">
                    <td style="border: 1px solid #ddd; padding: 8px;">{{ $include->title }}</td>
                    <td style="border: 1px solid #ddd; padding: 8px;">{{ float_amount_with_currency_symbol($include->price) }}</td>
                    <td style="border: 1px solid #ddd; padding: 8px;">{{ $include->quantity }}</td>
                    <td style="border: 1px solid #ddd; padding: 8px;">{{ float_amount_with_currency_symbol($include->price * $include->quantity) }}</td>
