                ...
                <ul class="metismenu" id="menu">
                    ...
                    @canany(['service-list'])
                        <li
                            ...
                            @if (request()->is(['admin-home/services/*','admin-home/services/service-book-settings','admin-home/services/service-details-settings',])) active @endif">
                    ...
                    <li
                        ...
                        @if (request()->is(['admin-home/orders/*','admin-home/orders/order-success-settings',])) active @endif">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-list-ol"></i>
                            <span>{{ __('Orders') }}</span></a>
                        <ul class="collapse">
                            @can('order-list')
                            <li class="@if (request()->is('admin-home/orders')) active @endif">
                                <a href="{{ route('admin.orders') }}" aria-expanded="true">
                                    <span>{{ __('All Orders') }}</span> @if($pending_order>=1)<span class="bage-notification"> {{ $pending_order }} </span> @endif
                                </a>
                            </li>
                            @endcan
                    ...
                    @canany(['payout-list', 'admin-commission','amount-settings'])
                        <li class="{{ active_menu('admin-home/area') }}
                            @if (request()->is('admin-home/seller-settings/*')) active @endif">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-back-right"></i>
                                <span>{{ __('Seller Settings') }}</span></a>
                            <ul class="collapse">
                                @canany(['payout-list'])
                                    <li class="@if (request()->is('admin-home/seller-settings/payout-request/all/*')) active @endif">
                                        <a href="{{ route('admin.payout.request.all') }}" aria-expanded="true"><i class="ti-money"></i>
                                            <span>{{ __('Payout Request') }}</span></a>
                                    </li>
                                @endcanany

                                @canany(['admin-commission'])
                                    <li class="@if (request()->is('admin-home/seller-settings/admin-commission/all')) active @endif">
                                        <a href="{{ route('admin.commission.all') }}" aria-expanded="true"><i class="ti-money"></i>
                                            <span>{{ __('Admin Commission') }}</span></a>
                                    </li>
                                @endcanany

                                @canany(['amount-settings'])
                                    <li class="@if (request()->is('admin-home/seller-settings/amount-settings/all')) active @endif">
                                        <a href="{{ route('admin.amount.settings') }}" aria-expanded="true"><i class="ti-money"></i>
                                            <span>{{ __('Amount Settings') }}</span></a>
                                    </li>
                                @endcanany
                            </ul>
                        </li>
