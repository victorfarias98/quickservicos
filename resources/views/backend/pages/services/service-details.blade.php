                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="single-checbox">
                                ...
                                <div class="checkbox-inlines">
                                    <p><strong>{{ __('Description:') }}</strong> {{ Str::limit($service->description,200) }}</p>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="single-checbox">
                                ...
                                <div class="checkbox-inlines">
                                    <label><strong>{{ __('Seller Since:') }}</strong> {{ Carbon\Carbon::parse($seller_since->created_at)->year }}</label>
                                </div>
