...
@else
    <div class="login-account">
        <a class="accounts" href="javascript:void(0)">{{ __('Account') }} <i class="las la-user"></i> </a>
        <ul class="account-list-item mt-2">
            <li class="list"> <a href="{{ route('user.register') }}"> {{ __('SignUp') }} </a> </li>
            <li class="list"> <a href="{{ route('user.login') }}">{{ __('SignIn') }} </a> </li>
        </ul>
    </div>
@endif
